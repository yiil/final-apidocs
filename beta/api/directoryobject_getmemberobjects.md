...
<!-- { "blockType": "ignored" } -->
```http
POST /users/<objectId>/manager/Microsoft.Graph.getMemberObjects
...
```http
POST https://graph.microsoft.com/beta/users/<objectId>/manager/Microsoft.Graph.getMemberObjects
