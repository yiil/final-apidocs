# Create trendingAround

Use this API to create a new trendingAround.
### Prerequisites
...
```http
POST https://graph.microsoft.com/v1.0/me/trendingAround
...
<!-- {
  ...
  "description": "Create trendingAround",
  "keywords": "",
